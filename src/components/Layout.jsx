...
const NAV_BY_ROLE = {
  admin: [
    ...
    { to: '/academics', label: 'Academics & Exams' },
  ...
  parent: [
    { to: '/', label: 'Overview', end: true },
    { to: '/attendance', label: "My Child's Attendance" },
    { to: '/academics', label: "My Child's Results" },
    { to: '/notices', label: 'Notice Board' },
    ...
    <div className="app-shell">
      <aside className="sidebar">
        <div className="sidebar-brand">
          ...
          <h1>Angel Public International School</h1>
        </div>
        <nav>
          {items.map(item => (
